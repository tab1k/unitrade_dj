...
SECRET_KEY = "django-insecure-n7w+l+j&hni476&m=nr$x4i3z)y3j(uewikpn^1yw37^$qh5y7"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "unitrade_db"),
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'unique-snowflake',  # Уникальное имя для вашей кэш-системы
    }
}
